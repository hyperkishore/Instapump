...
(function() {
  ...
  // ========================================
  // Listen for messages from popup (Safari uses browser.runtime)
      ...
      if (message.type === 'GET_STATE') {
        ...
        const state = {
          ...
          stats: {
            ...
            timeSaved: Math.round((sessionStats.reelsSkipped * 20) / 60), // minutes
        ...
        // Remove single username from a list
